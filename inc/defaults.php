...
$vertice_theme_divider_style = array(
...
return array(
	...
	'icons'                             => $vertice_theme_svg_icons,
	'divider_style'                     => $vertice_theme_divider_style,
	'lorem_ipsum'                       => $vertice_lorem_ipsum,
	'edit_this_text_in_customizer'      => $vertice_theme_click_pen_to_edit_title,
	'gradients'                         => $vertice_gradients,
	...
	'front-header'                      => array(
		...
		'buttons'      => array(
			...
			'value' => array(
				array(
					'label'       => sprintf( $vertice_theme_action_button, 1 ),
					'url'         => '#',
					'button_type' => '0',
					'index'       => 0,
				),
				array(
					'label'       => sprintf( $vertice_theme_action_button_secondary, 1 ),
					'url'         => '#',
					'button_type' => '1',
					'index'       => 1,
				),
		...
		'title'        => array(
			'show'  => true,
			'value' => $vertice_theme_click_pen_to_edit_title,
			'style' => array(
				'descendants' => array(
					'text' => array(
						'textAlign' => 'center',
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									'type'             => 'color',
									'color'            => array(
										'value' => 'rgba(18,19,21,0.55)',
									),
									'gradient'         => $vertice_gradients['night_fade'],
									'gradient_opacity' => 50,
									'shape'            =>
										array(
											'value'  => 'none',
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $vertice_theme_svg_icons['facebook-square'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $vertice_theme_svg_icons['whatsapp-square'],
						'link_value' => '#',
						'index'      => 1,
					),
					array(
						'icon'       => $vertice_theme_svg_icons['youtube-play'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
						'icon'       => $vertice_theme_svg_icons['yahoo-square'],
						'link_value' => '#',
						'index'      => 3,
					),
				),
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $vertice_theme_svg_icons['map-marker'],
						'text'       => 'Location, State, Country',
						'link_value' => 'https://maps.google.com/',
						'index'      => 0,
					),
					array(
						'icon'       => $vertice_theme_svg_icons['phone'],
						'text'       => '(000) 123 12345',
						'link_value' => 'tel:+400 098 765 432',
						'index'      => 1,
					),
					array(
						'icon'       => $vertice_theme_svg_icons['envelope'],
	...
	'header'                            => array(
						...
						'background' => array(
							...
							'overlay'   =>
								array(
									...
									'gradient'         => $vertice_gradients['inner_header_default_overlay'],
									'gradient_opacity' => 40,
									'shape'            =>
										array(
											'value'  => 'none',
							...
							'image'     => array(
								array(
									'source'     => array(
										'url'      => get_template_directory_uri() . '/resources/images/background-image-inner.jpg',
										'gradient' => $vertice_gradients['night_fade'],
									),
									'attachment' => 'scroll',
								),
		...
		'social_icons' => array(
			...
			'localProps' => array(
				'icons' => array(
					array(
						'icon'       => $vertice_theme_svg_icons['facebook'],
						'link_value' => '#',
						'index'      => 0,
					),
					array(
					...
					array(
						'icon'       => $vertice_theme_svg_icons['youtube'],
						'link_value' => '#',
						'index'      => 2,
					),
					array(
		...
		'icon_list'    => array(
			...
			'localProps' => array(
				'iconList' => array(
					array(
						'icon'       => $vertice_theme_svg_icons['map-pin'],
						'text'       => '1557 Frosty Lane, Binghamton, NY',
						'link_value' => '#',
						'index'      => 0,
					),
					array(
						'icon'       => $vertice_theme_svg_icons['phone-square'],
	...
	'blog_post_thumb_placeholder_color' => 'rgb(163,172,190)',
